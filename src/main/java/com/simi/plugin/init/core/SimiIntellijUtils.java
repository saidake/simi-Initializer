...
@UtilityClass
@Slf4j
public class SimiIntellijUtils {
    ...
    private static String deepCheckDirectory(boolean hasUpperPom,String projectName, VirtualFile virtualFile) throws DocumentException, IOException {
        ...
        for (VirtualFile child : virtualFile.getChildren()) {
            if(child.isDirectory()){
                ...
                Optional<HashMap<String, String>> pomNameSpaceMap = SimiXmlUtils.createNamespaceMap(readPomDocument);
                Node node = SimiXmlUtils.selectSingleNodeListWithNSXpath(pomNameSpaceMap.orElse(null), readPomDocument, "/project/artifactId");
